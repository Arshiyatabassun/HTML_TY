//[7:19 am, 02/01/2022] +91 91486 80727: 
...
function addToTable() {
  ...
  var input1 = document.getElementById("username"); //taking tags
  // console.log(input1);
  var input2 = document.getElementById("email");
  var input3 = document.getElementById("password");
  var input4 = document.getElementById("age");
  let input5 = document.getElementsByName("radioOptions")
  // let input6 = document.getElementsByClassName("check-input")

  // var name = input1.value; //storig values of the input tags
  // var age = input2.value;
  // var phoneNo = input3.value;

  var gender;

  var gender = input5.forEach((inp) => {
    if (inp.checked) {
      gender = inp.value;
      // console.log(gender);
    }
    ...
    // var check = input6.forEach((option) =>{
    //   if(option.checked){
    //     check = option.value;
    //   }
    // })
  ...
  data1.textContent = input1.value;
  data2.textContent = input2.value;
  data3.textContent = input3.value;
  data4.textContent = input4.value;
  data5.textContent = gender;
  // data6.textContent = check;
